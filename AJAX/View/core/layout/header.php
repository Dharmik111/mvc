<nav class="navbar navbar-expand-md navbar-light bg-light" style="background-color: orange;">
    ...
    <a class="navbar-brand mb-0 h1" style="width: 8rem;" href="javascript:void(0)" onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('grid', 'configGroup') ?>').resetParams().load();">Config Group</a>
