...
<form id="form" action="" method="POST">
    ...
    <input class="btn btn-primary" type="button" onclick="mage.changeAction('<?php echo $this->getUrl()->getUrl('grid','product'); ?>').setForm();" value="Back to Product">
    <input class="btn btn-primary" type="button" onclick="mage.changeAction('<?php echo $this->getUrl()->getUrl('update','cart'); ?>').setForm();" value="Update">
    ...
    <br><br>
    <center><input type="button" onclick="mage.setUrl('<?php echo $this->getUrl()->getUrl('placeOrder','cart\PlaceOrder',['cartId'=>$cart->cartId]); ?>').load();" value="Place Order"></center>
</form>