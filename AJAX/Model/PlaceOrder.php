...
class PlaceOrder extends \Model\Core\Table
{
    ...
    {
        $query = "SELECT * FROM `orderaddress` WHERE `orderId` = '{$this->orderId}' AND `addressType` = '" . \Model\PlaceOrder\Address::ADDRESS_TYPE_BILLING . "'";
    ...
    {
        $query = "SELECT * FROM `orderaddress` WHERE `orderId` = '{$this->placeOrderId}' AND `addressType` = '" . \Model\Cart\Address::ADDRESS_TYPE_SHIPPING . "'";
